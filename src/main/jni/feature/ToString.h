...
std::string RankToString(int uiRankLevel, int iMythPoint) {
    if (uiRankLevel > 135) {
        if (iMythPoint >= 100) {
            return "Mythical Immortal: " + to_string(iMythPoint);
        } else if (iMythPoint >= 50) {
            return "Mythic Glory: " + to_string(iMythPoint);
        } else if (iMythPoint >= 25) {
            return "Mythical Honor: " + to_string(iMythPoint);
        }
    } else {
...
std::string MonsterToString(int m_id) {
    ...
    case 2013:
        ...
        break;
    case 2056:
        strMonster += "Lithowanderer 1";
        break;
    case 2059:
        strMonster += "Crammer 2";
        break;
    case 2072:
        strMonster += "Lithowanderer 2";
        break;
    default:
